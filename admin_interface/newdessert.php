 ...
 * @Date: 2022-05-23 17:29:04
 * @Last Modified by: Beatrice Abrahamsson
 * @Last Modified time: 2022-05-26 16:44:14
 * @Description: Description
 */

//set page title
$page_title = "Lägg till efterätt";
//includes
include("includes/header.php");
include("includes/restrict.php");
?>
                <div class="blogpost">
                <h2>Lägg till efterätt:</h2>
                <?php
                ...
                $url = 'https://studenter.miun.se/~beab2100/writeable/dt173g/Projekt/Webbtjanst/dessertapi.php';
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if (!empty($name) || !empty($price) || !empty($description)) {
                            ...
                            curl_close($curl);
                            if($httpcode === 201) {
                                header("Location: menu.php?message=Efterätt tillagd!");
                    
                            } else {
                                header("Location: menu.php?error=Fel vid lagring av efterätt!");
                            }
                        }
                    }
                    ?><!--Form to add dessert-->
                    ...
                    <div class="form-container">
                        <form name="newDessert" method="post" onsubmit="return validateNewDessert()">
                            ...
                            <input type="submit" name="submit" value="Lägg till efterätt">
                        </form>
                    </div>
        </div>
    <?php
